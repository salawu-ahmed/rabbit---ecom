...
export default function ({isOpen, onClose}) {
  ...
  return (
    <div className={`fixed top-0 right-0 w-3/4 sm:w-1/2 md:w-2/6 h-full bg-white transform shadow-lg transition-transform duration-300 flex flex-col z-50 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
